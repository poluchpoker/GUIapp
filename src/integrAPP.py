...
class Definite_Integral(tk.Frame):
    def __init__(self, parent, controller):
        ...
        button_indefinite_integral = ttk.Button(self, text="Неопределенные интегралы",
                            command=lambda: controller.show_frame(Indefinite_Integral))
        button_indefinite_integral.grid(row=3, column=2, padx=10, pady=55, columnspan=1, ipadx=40, ipady=40)
        ...
        button_replacement_variable = ttk.Button(self, text="Интегрирование заменой переменной",
                            command=lambda: controller.show_frame(Indefinite_Integral))
        button_replacement_variable.grid(row=2, column=1, padx=10, pady=55, columnspan=1, ipadx=40, ipady=40)
        ...
        button_introduction_under_dif_sign.grid(row=2, column=3, padx=40, pady=60, columnspan=1, ipadx=40, ipady=40)
...
class Indefinite_Integral(tk.Frame):
    def __init__(self, parent, controller):
        ...
        button_definite_integral = ttk.Button(self, text="Определенные интегралы",
                            command=lambda: controller.show_frame(Definite_Integral))
        button_definite_integral.grid(row=3, column=2, padx=10, pady=10, ipadx=40, ipady=40)
